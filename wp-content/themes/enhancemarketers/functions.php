...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style( 'fontawesomecss', get_template_directory_uri() . '/inc/assets/css/fontawesome.min.css' );
    wp_enqueue_style( 'fontawesomebrands', get_template_directory_uri() . '/inc/assets/css/brands.min.css' );
    wp_enqueue_style( 'fontawesomesolid', get_template_directory_uri() . '/inc/assets/css/fsolid.min.css' );
    wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/inc/assets/css/style.css' );
...
require get_template_directory() . '/metabox/meta_functions.php';
/**
